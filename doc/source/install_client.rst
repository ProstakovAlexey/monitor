...
4. Попробуйте запрос на виды сведений, например на кол-во заявлений с ПГУ: `python monitorRequest.py -a 192.168.0.104 -p 80 -s monitor -m requestSmev`. Результат - число больше 0, если -1 - по возникла ошибка.
